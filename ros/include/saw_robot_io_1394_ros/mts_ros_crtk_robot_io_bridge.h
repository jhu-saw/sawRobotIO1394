...
#ifndef _mts_ros_crtk_robot_io_bridge_h
#define _mts_ros_crtk_robot_io_bridge_h

#include <cisstMultiTask/mtsComponent.h>
#include <cisst_ros_crtk/mts_ros_crtk_bridge_provided.h>

class CISST_EXPORT mts_ros_crtk_robot_io_bridge: public mtsComponent
{
...
CMN_DECLARE_SERVICES_INSTANTIATION(mts_ros_crtk_robot_io_bridge);

#endif // _mts_ros_crtk_robot_io_bridge_h
